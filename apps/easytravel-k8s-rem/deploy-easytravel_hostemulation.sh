...
sed 's~domain.placeholder~'"$DOMAIN"'~' manifests_hostemulation/ingress.template > manifests_hostemulation/ingress-gen.yaml

kubectl -n easytravel apply -f manifests_hostemulation/
