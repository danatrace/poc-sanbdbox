...
sed 's~domain.placeholder~'"$DOMAIN"'~' manifests_loginproblems/ingress.template > manifests_loginproblems/ingress-gen.yaml

kubectl -n easytravel apply -f manifests_loginproblems/
