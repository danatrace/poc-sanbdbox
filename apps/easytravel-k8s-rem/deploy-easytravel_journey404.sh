...
sed 's~domain.placeholder~'"$DOMAIN"'~' manifests_journeysearcherror404/ingress.template > manifests_journeysearcherror404/ingress-gen.yaml

kubectl -n easytravel apply -f manifests_journeysearcherror404/
