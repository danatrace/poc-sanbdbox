...
sed 's~domain.placeholder~'"$DOMAIN"'~' manifests_largememoryleak/ingress.template > manifests_largememoryleak/ingress-gen.yaml

kubectl -n easytravel apply -f manifests_largememoryleak/
