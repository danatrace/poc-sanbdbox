...
sed 's~domain.placeholder~'"$DOMAIN"'~' manifests_journeysearcherror500/ingress.template > manifests_journeysearcherror500/ingress-gen.yaml

kubectl -n easytravel apply -f manifests_journeysearcherror500/
