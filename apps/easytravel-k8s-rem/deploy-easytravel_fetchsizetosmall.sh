...
sed 's~domain.placeholder~'"$DOMAIN"'~' manifests_fetchsizetosmall/ingress.template > manifests_fetchsizetosmall/ingress-gen.yaml

kubectl -n easytravel apply -f manifests_fetchsizetosmall/
