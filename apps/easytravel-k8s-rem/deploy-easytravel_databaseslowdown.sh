...
sed 's~domain.placeholder~'"$DOMAIN"'~' manifests_databaseslowdown/ingress.template > manifests_databaseslowdown/ingress-gen.yaml

kubectl -n easytravel apply -f manifests_databaseslowdown/
