...
sed 's~domain.placeholder~'"$DOMAIN"'~' manifests_badcachesync/ingress.template > manifests_badcachesync/ingress-gen.yaml

kubectl -n easytravel apply -f manifests_badcachesync/
